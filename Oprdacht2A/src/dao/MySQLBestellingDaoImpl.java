...
public class MySQLBestellingDaoImpl extends BestellingDaoImpl{
	
	private static final Logger logger =  LoggerFactory.getLogger(MySQLBestellingDaoImpl.class);
	...
	public int create(Bestelling bestelling) {
		...
		logger.info("insert query for MySQL executed");
	...
	public List<Bestelling> read() {						
		...
		logger.info("select query for MySQL executed");
		return super.read();
	}
	@Override
	public int update(Bestelling bestelling) {
		...
		logger.info("select and insert queries for MySQL executed");
	...
	public int delete(Bestelling bestelling) {
		...
		logger.info("delete query for MySQL executed");
